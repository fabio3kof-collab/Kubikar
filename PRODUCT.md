...
- Método de cálculo: la cantidad sale de la planta. Los ejes de perfilería se recortan contra el polígono y entregan corridas de largo real; el perfil perimetral usa los lados del polígono; la plancha cuenta las posiciones de la retícula que tocan el recinto. Los tornillos son dos y se cuentan donde van: el drywall punta fina sobre los metros lineales de perfilería, que es donde se atornilla la plancha, y el punta broca cabeza de lenteja por punto de unión metal-metal, o sea los dos extremos de cada corrida más un tornillo por colgante. Solo el colgante sale de una densidad por metro cuadrado. Sobre eso se aplica el porcentaje de desperdicio, que cubre rotura y error de corte y ya no carga con el retazo. Cada resultado muestra la cantidad teórica antes del redondeo y del desperdicio.
